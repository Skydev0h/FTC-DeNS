...
root = Root()
assert eq(root.address(), ts4.Address('0:7777777777777777777777777777777777777777777777777777777777777777'))
...
assert eq(test.address(), ts4.Address('0:1111111111111111111111111111111111111111111111111111111111111111'))
test2 = ts4.BaseContract('DensTest', {'_root': root.address()}, nickname='Test2', override_address=ts4.Address('0:' + (64 * '2')))
assert eq(test2.address(), ts4.Address('0:2222222222222222222222222222222222222222222222222222222222222222'))
...
assert eq(cc.call_getter('root'), root.address())
assert eq(cc.call_getter('owner'), ts4.Address('0:4444444444444444444444444444444444444444444444444444444444444444'))
...
assert eq(cc.call_getter('owner'), ts4.Address('0:2222222222222222222222222222222222222222222222222222222222222222'))
assert eq(sc.call_getter('owner'), ts4.Address('0:1111111111111111111111111111111111111111111111111111111111111111'))
...
assert eq(cc.call_getter('owner'), ts4.Address('0:2222222222222222222222222222222222222222222222222222222222222222'))
assert eq(sc.call_getter('owner'), ts4.Address('0:2222222222222222222222222222222222222222222222222222222222222222'))
